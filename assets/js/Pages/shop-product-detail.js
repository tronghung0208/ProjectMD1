...
function showProductDetail() {
  ...
  // show image
  document
    .querySelector(".product_img_box img")
    .setAttribute("src", product.image);
  document.querySelector(".pr_detail .product_title a").innerText =
    product.nameProduct;
  document.querySelector(".pr_detail .product_price span").innerText =
    "$" + product.price;
      ...
      `<div class="item">
            <div class="product">
                ...
                <div class="product_info">
                    <h6 class="product_title"><a href="shop-product-detail.html">${productItem.nameProduct}</a></h6>
